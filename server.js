...
async function buildClashConfigByLinks(links = []) {
  ...
  const builtInBase = {
    ...
    'rule-providers': {
      ...
      my_blacklist: { type: 'http', behavior: 'classical', format: 'yaml', url: 'https://raw.githubusercontent.com/Spittingjiu/mihomo-custom-rules/main/my_blacklist.yaml', path: './ruleset/custom/my_blacklist.yaml', interval: 86400 },
